...
```
curl -v -X POST -H "Content-Type: application/json" -d '{"caCrl":"http://http.fpki.gov/fcpca/fcpca.crl","caCert":""}' https://api.fpki.io/v1/ca | python -m json.tool
curl -X POST -H "Content-Type: application/json" -d ./data/common.json https://api.fpki.io/v1/ca | python -m json.tool
...
curl -s -v https://api.fpki.io/v1/caPathAsPEM > fpki.pem 
curl -s -v https://api.fpki.io/v1/caPathAsPEM/CD9A1C6072C1EBBEAEC5ABAC4990EB4D8EF1DFAE > ocio_ca_fullpath.pem
...
```
openssl crl2pkcs7 -outform DER -out ocio_ca_fullpath.p7b -nocrl -certfile ocio_ca_fullpath.pem
```
